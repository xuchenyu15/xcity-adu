...
const MODELS = [
  {
    id: 'indus-pod',
    name: 'IndusPod',
    descriptionKey: 'modelsPage.model.indusPod.desc',
    image: indusPodMain,
    featureKeys: [
      'modelsPage.model.indusPod.feature0',
      'modelsPage.model.indusPod.feature1',
      'modelsPage.model.indusPod.feature2'
    ]
  },
  {
    id: 'aura',
    name: 'Aura',
    descriptionKey: 'modelsPage.model.aura.desc',
    image: auraImg,
    featureKeys: ['modelsPage.model.aura.feature0', 'modelsPage.model.aura.feature1', 'modelsPage.model.aura.feature2']
  },
  {
    id: 'classic',
    name: 'Classic',
    descriptionKey: 'modelsPage.model.classic.desc',
    image: classicImg,
    featureKeys: [
      'modelsPage.model.classic.feature0',
      'modelsPage.model.classic.feature1',
      'modelsPage.model.classic.feature2'
    ]
  }
];
  ...
  return (
    <div className={`min-h-screen ${isDark ? 'bg-slate-950 text-slate-300' : 'bg-slate-50 text-slate-900'}`}>
      ...
      <section className="relative h-[90vh] flex flex-col items-center justify-center text-center px-6 overflow-hidden bg-slate-950">
        ...
        <div className="absolute inset-0">
           <img 
             ...
             alt={t('modelsPage.systemCoreAlt')} 
        ...
        <div className="relative z-10 max-w-5xl mx-auto space-y-8">
          ...
          <div className="inline-flex items-center gap-3 px-6 py-2 rounded-full bg-slate-900/50 backdrop-blur-md border border-slate-700/50 mb-2 shadow-xl shadow-black/20">
             ...
             <span className={`text-blue-500 text-sm font-bold ${language === 'zh' ? 'tracking-[0.12em]' : 'tracking-[0.2em] uppercase'}`}>
                {t('modelsPage.heroEyebrow')}
             </span>
          </div>
          
          <h1 className={`text-6xl md:text-8xl font-bold tracking-tight ${isDark ? 'text-white' : 'text-slate-900'}`}>
            {t('modelsPage.heroTitleA')} <br />
            <span className="text-blue-500">{t('modelsPage.heroTitleB')}</span>
          </h1>

          {/* Subtitle Text */}
          <div className="mt-8 flex flex-col items-center justify-center gap-2">
             <p className={`text-lg md:text-xl font-medium tracking-wide ${isDark ? 'text-slate-300' : 'text-slate-600'}`}>
               {t('modelsPage.heroSubA')}
             </p>
             <p className={`text-lg md:text-xl font-medium tracking-wide ${isDark ? 'text-slate-300' : 'text-slate-600'}`}>
               {t('modelsPage.heroSubB')}
             </p>
          </div>
        </div>
      ...
      <section className={`py-24 px-6 border-y ${isDark ? 'bg-slate-900/50 border-slate-800' : 'bg-white border-slate-200'}`}>
        <div className="max-w-7xl mx-auto w-full">
          <div className="text-center mb-16">
            <span className={`text-xs font-bold text-blue-500 mb-4 block ${language === 'zh' ? 'tracking-normal' : 'tracking-widest uppercase'}`}>{t('modelsPage.systemLogicEyebrow')}</span>
            <h2 className={`text-3xl md:text-4xl font-bold mb-6 ${isDark ? 'text-white' : 'text-slate-900'}`}>
              {t('modelsPage.systemLogicTitle')}
            </h2>
            <p className={`max-w-4xl mx-auto whitespace-nowrap overflow-hidden text-ellipsis ${isDark ? 'text-slate-400' : 'text-slate-600'}`}>
               {t('modelsPage.systemLogicDesc')}
            </p>
          </div>
            ...
            <div className="space-y-6 text-center group">
              ...
              <div>
                <h3 className={`text-lg font-bold mb-2 ${isDark ? 'text-white' : 'text-slate-900'}`}>{t('modelsPage.step1Title')}</h3>
                <p className="text-sm text-slate-500">{t('modelsPage.step1Desc')}</p>
              </div>
            </div>
            ...
            <div className="space-y-6 text-center group">
              ...
              <div>
                <h3 className={`text-lg font-bold mb-2 ${isDark ? 'text-white' : 'text-slate-900'}`}>{t('modelsPage.step2Title')}</h3>
                <p className="text-sm text-slate-500">{t('modelsPage.step2Desc')}</p>
              </div>
            </div>
            ...
            <div className="space-y-6 text-center group">
              ...
              <div>
                <h3 className={`text-lg font-bold mb-2 ${isDark ? 'text-white' : 'text-slate-900'}`}>{t('modelsPage.step3Title')}</h3>
      ...
      <section id="model-selection" className="py-24 px-6 min-h-screen flex flex-col justify-center">
        <div className="max-w-7xl mx-auto w-full">
           <div className="text-center mb-16">
              <h2 className={`text-4xl font-bold mb-6 ${isDark ? 'text-white' : 'text-slate-900'}`}>{t('modelsPage.selectTitle')}</h2>
               ...
               return (
                 ...
                 >
                   ...
                   <div className="p-6 flex flex-col gap-6">
                      ...
                      >
                          {model.featureKeys.map((featKey, i) => (
                              <span 
                                  key={i} 
                                  className={`inline-flex items-center justify-center text-[10px] font-bold px-4 py-2.5 rounded-full shrink-0 ${language === 'zh' ? 'tracking-normal' : 'uppercase tracking-[0.12em]'} ${
            ...
            <div className="max-w-[1600px] mx-auto px-6 py-12 md:py-20">
                ...
                <div className="grid md:grid-cols-[3fr_1fr] gap-12 lg:gap-24 mb-24 items-start">
                    ...
                    <div className="space-y-16">
                        ...
                        <div className="grid md:grid-cols-2 gap-12 items-stretch pt-20 pb-10 border-t border-slate-200/10">
                            ...
                            <div className="flex flex-col h-full">
                                <h3 className={`text-2xl font-bold mb-8 ${isDark ? 'text-white' : 'text-slate-900'}`}>{t('modelsPage.specs.title')}</h3>
                                
                                <div className="flex-1 flex flex-col justify-between">
                                    {/* Interior Area */}
                                    <div className={`flex justify-between items-center py-4 border-b ${isDark ? 'border-slate-800' : 'border-slate-200'}`}>
                                        <span className={`font-medium ${isDark ? 'text-slate-500' : 'text-slate-500'}`}>{t('modelsPage.specs.interiorArea')}</span>
                                        <span className={`font-bold text-xl ${isDark ? 'text-white' : 'text-slate-900'}`}>600 sqft</span>
                                    </div>

                                    {/* Configuration */}
                                    <div className={`flex justify-between items-center py-4 border-b ${isDark ? 'border-slate-800' : 'border-slate-200'}`}>
                                        <span className={`font-medium ${isDark ? 'text-slate-500' : 'text-slate-500'}`}>{t('modelsPage.config.label')}</span>
                                        <span className={`font-bold text-xl ${isDark ? 'text-white' : 'text-slate-900'}`}>{configLabel}</span>
                                    </div>

                                    {/* Dimensions */}
                                    <div className={`flex justify-between items-center py-4 border-b ${isDark ? 'border-slate-800' : 'border-slate-200'}`}>
                                        <span className={`font-medium ${isDark ? 'text-slate-500' : 'text-slate-500'}`}>{t('modelsPage.specs.dimensions')}</span>
                                    ...
                                    <div className={`flex justify-between items-center py-4 ${exteriorArea > 0 ? 'visible' : 'invisible'}`}>
                                        <span className="font-medium text-blue-500">{t('modelsPage.specs.exteriorArea')}</span>
                    ...
                    <div className="sticky top-12 h-fit space-y-10">
                        ...
                        {/* A. Interior Layout */}
                        <div>
                            <h4 className={`text-xs font-bold mb-4 opacity-70 ${language === 'zh' ? 'tracking-normal' : 'uppercase tracking-wider'}`}>{t('modelsPage.config.interiorLayout')}</h4>
