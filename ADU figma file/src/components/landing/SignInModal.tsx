            ...
            >
              ...
              <div className="p-8">
                ...
                <div className="text-center mb-8">
                  ...
                  <p className="text-slate-400">Sign in to access your Design Studio</p>
                </div>
                ...
                <p className="text-center mt-8 text-xs text-slate-500">
                  By continuing, you agree to our <a href="#" className="underline hover:text-slate-400">Terms of Service</a> and <a href="#" className="underline hover:text-slate-400">Privacy Policy</a>.
                </p>
              </div>
            </motion.div>
          </motion.div>
